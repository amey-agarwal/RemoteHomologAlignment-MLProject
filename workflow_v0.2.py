...
def get_3di_fasta(pdb_directory):
    """
...
def run_alignment(fasta_file, aligner_method):
    ...
    try:
        if aligner_method == 'mafft':
            ...
            cmd_string = f"{mafft} --clustalout --aamatrix {fs_mat_file} --globalpair --maxiterate 1000 {fasta_file} > {output_alignment}"
...
def main():
    ...
    cleaned_alignment_file = "3Di_clean.aln"
